...
import belanjamudah from '../img/belanjamudah.png'
import beritanejowo from '../img/beritanejowo.png'
        ...
        <main className="main-content">
            ...
            <div className='wrapping-project'>
                ...
                <ScrollingCarousel className='items-project' show={3.5} slide={3} swiping={true}>
                    ...
                    <Item judul="MBKM UNIKAMA" deskripsi="Merupakan Website monitoring dikampus UNIKAMA." gambar={mbkm} />
                    <Item judul="Belanja Mudah" deskripsi="Merupakan project UAS saya dibuat dengan CRUD Sederhana." gambar={belanjamudah}/>
                    <Item judul="Beritanejowo" deskripsi="Merupakan blog content yang saya bangun tujuan untuk informasi." gambar={beritanejowo} />   
